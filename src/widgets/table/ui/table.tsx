      ...
      <table className="border-x-1 border-gray-200 w-full">
        <thead>
          <tr className="border-1 border-gray-200 text-sm md:text-base">
            <th className="p-2 md:p-4 text-start">Описание</th>
            <th className="p-2 md:p-4 text-start">Статус</th>
            <th className="p-2 md:p-4 text-start">Категория</th>
            <th className="p-2 md:p-4 text-start">Дата</th>
          </tr>
        </thead>
        <tbody>
